...
const Services = () => {
    const landingServices = [
        ...
        {
          title: "SIMULADOR DE PLÚSVALIA",
          description: "CALCULADORA PLÚSVALÍA",
  ...
  return (
    <div className="flex w-full flex-col justify-center gap-7 py-5">
      <h2 className="text-center text-xl font-extrabold leading-[30px] text-[#004870] sm:text-[42px] sm:leading-[63px]">
        Gestiona Mogán , al servicio del ciudadano
      </h2>
